...
namespace AdrenalineModifier
{
    ...
    public class Main : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            ...
            AdrenalineMultiplier = Config.Bind("General", "AdrenalineMultiplier", 1.0f, "Multiplier to gained adrenaline (example: harder 0.5, standard 1.0, easier 1.5)");
            AdrenalineDecayMultiplier = Config.Bind("General", "AdrenalineDecayMultiplier", 1.0f, "Multiplier to lost adrenaline (example: harder 1.5, standard 1.0, easier 0.5)");
            AdrenalineDecayDelayMultiplier = Config.Bind("General", "AdrenalineDecayDelayMultiplier", 1.0f, "Multiplier to delay before adrenaline decay starts (example: harder 0.5, standard 1.0, easier 1.5)");
